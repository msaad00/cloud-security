...
- CycloneDX capabilities overview (ML-BOM / SaaSBOM / evidence): https://cyclonedx.org/capabilities/
- CycloneDX v1.5 release notes introducing ML-BOM: https://cyclonedx.org/news/cyclonedx-v1.5-released/
- CycloneDX AI models and model cards use case: https://cyclonedx.org/use-cases/ai-models-and-model-cards/
- CycloneDX software dependency use case (`bom-ref`, dependency graph rules): https://cyclonedx.org/use-cases/software-dependencies/
